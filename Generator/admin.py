...
from SFIAGenerator.settings import MEDIA_ROOT
...
def download(modeladmin,request,queryset):
   for file in queryset:
       ...
       response['Content-Disposition'] = 'attachment;filename="1.json"'
       return response
download.short_description = 'dowmload'
